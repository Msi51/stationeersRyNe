...
internal class StringCompressor
{
	...
	public static string CompressStringLZ4(string text)
	{
		return Convert.ToBase64String(LZ4Codec.Wrap(Encoding.UTF8.GetBytes(text)));
	}

	public static string DecompressStringLZ4(string compressedText)
	{
		byte[] bytes = LZ4Codec.Unwrap(Convert.FromBase64String(compressedText));
