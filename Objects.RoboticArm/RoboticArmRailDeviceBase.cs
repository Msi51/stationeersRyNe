...
public class RoboticArmRailDeviceBase : SmallDevice, INetworkedRoboticArm, INetworkedStructure, INetworkMember, IReferencable, IEvaluable, ISmartRotatable
{
	...
	protected override void InitialiseSaveData(ref ThingSaveData thingSaveData)
	{
		...
		if (thingSaveData is RoboticArmRailDeviceBaseSaveData roboticArmRailDeviceBaseSaveData)
		{
			roboticArmRailDeviceBaseSaveData.RoboticArmNetworkId = RoboticArmNetwork?.ReferenceId ?? 0;
		}
	}
	...
	public override void DeserializeSave(ThingSaveData thingSaveData)
	{
		...
		if (thingSaveData is RoboticArmRailDeviceBaseSaveData { RoboticArmNetworkId: var roboticArmNetworkId })
		{
