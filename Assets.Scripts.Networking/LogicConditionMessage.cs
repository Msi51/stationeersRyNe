...
public class LogicConditionMessage : ProcessedMessage<LogicConditionMessage>
{
	...
	public override void Process(long hostId)
	{
		...
		if (IsDeleting)
		{
			logicMotherboard.RemoveCondition(LogicStateIndex, Index);
			return;
		}
		Thing device = Thing.Find<Thing>(DeviceId);
		logicMotherboard.AddOrNewCondition(LogicStateIndex, Index, device, LogicType, ConditionOperation, Value);
	}
	...
	public override void Deserialize(RocketBinaryReader reader)
	{
		...
		ConditionOperation = (ConditionOperation)reader.ReadByte();
	...
	public override void Serialize(RocketBinaryWriter writer)
	{
		...
		writer.WriteByte((byte)ConditionOperation);
