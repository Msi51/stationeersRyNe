...
public class ElectronicsPrinter : SimpleFabricatorBase
{
	private bool isDone;
	...
	public static DynamicThingRecipeComparable RecipeComparable = new DynamicThingRecipeComparable("ElectronicsPrinter");
	...
	protected override void OnBuildStateUpdated(int newState, int previousState)
	{
		...
		{
			Achievements.AssessMyNextForm(this, newState);
		}
	}
}
