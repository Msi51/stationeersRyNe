...
public class HydraulicPipeBender : SimpleFabricatorBase
{
	private bool isDone;
	...
	public static DynamicThingRecipeComparable RecipeComparable = new DynamicThingRecipeComparable("HydraulicPipeBender");
