...
public class RocketManufactory : AnimComponentManufactory
{
	public static readonly DynamicThingRecipeComparable RecipeComparable = new DynamicThingRecipeComparable("RocketManufactory");
