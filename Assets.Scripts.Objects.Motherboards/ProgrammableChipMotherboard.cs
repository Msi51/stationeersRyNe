...
public class ProgrammableChipMotherboard : Motherboard, ISourceCode, IReferencable, IEvaluable
{
	...
	[SerializeField]
	private ButtonDropdown _dropdown;
	...
	public override void DeserializeSave(ThingSaveData savedData)
	{
		...
		if (savedData is ProgrammableChipMotherboardSaveData programmableChipMotherboardSaveData)
		{
			...
			_dropdown.SetSelectedIndex(programmableChipMotherboardSaveData.DeviceIndex);
		}
	}
	...
	protected override void InitialiseSaveData(ref ThingSaveData savedData)
	{
		...
		if (savedData is ProgrammableChipMotherboardSaveData programmableChipMotherboardSaveData)
		{
			...
			programmableChipMotherboardSaveData.DeviceIndex = _dropdown.SelectedIndex;
		}
	}
	...
	public void Import()
	{
		if (_circuitHolders.Count > _dropdown.SelectedIndex)
		{
			ICircuitHolder circuitHolder = _circuitHolders[_dropdown.SelectedIndex];
