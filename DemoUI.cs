...
public class DemoUI : MonoBehaviour
{
	...
	private void OnGUI()
	{
		...
		m_SSAOPro.Samples = (value2 ? SSAOPro.SampleCount.Medium : m_SSAOPro.Samples);
		value2 = m_SSAOPro.Samples == SSAOPro.SampleCount.High;
		value2 = GUILayout.Toggle(value2, "16 samples");
		m_SSAOPro.Samples = (value2 ? SSAOPro.SampleCount.High : m_SSAOPro.Samples);
		value2 = m_SSAOPro.Samples == SSAOPro.SampleCount.Ultra;
		value2 = GUILayout.Toggle(value2, "20 samples");
		m_SSAOPro.Samples = (value2 ? SSAOPro.SampleCount.Ultra : m_SSAOPro.Samples);
		GUI.EndGroup();
	}
}
