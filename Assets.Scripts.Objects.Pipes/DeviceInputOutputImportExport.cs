...
public class DeviceInputOutputImportExport : DeviceInputOutputImport
{
	...
	{
		ThingSaveData savedData = new DeviceInputOutputImportExportSaveData();
	...
	public override void DeserializeSave(ThingSaveData savedData)
	{
		...
		if (savedData is DeviceInputOutputImportExportSaveData deviceInputOutputImportExportSaveData)
		{
			ExportCount = deviceInputOutputImportExportSaveData.ExportCount;
			SetExportState(deviceInputOutputImportExportSaveData.ExportState);
	...
	protected override void InitialiseSaveData(ref ThingSaveData savedData)
	{
		...
		if (savedData is DeviceInputOutputImportExportSaveData deviceInputOutputImportExportSaveData)
		{
			deviceInputOutputImportExportSaveData.ExportCount = ExportCount;
			deviceInputOutputImportExportSaveData.ExportState = _exportState;
		}
	}
	...
	protected virtual void OnServerExportTick(float deltaTime)
	{
	}
	...
	public override void OnChildExitInventory(DynamicThing previousChild)
	{
		...
		if (GameManager.RunSimulation && !(ExportingThing != previousChild))
		{
			ExportingThing = null;
		}
	}
